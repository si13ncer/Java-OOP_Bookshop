package group10.bookShop.loginConfig;
...
import group10.bookShop.service.loginService.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/book", "/book/login", "/logout").permitAll();
